...
interface RepositoriesClientPageProps {
  initialUser: UserInfo
}

export default function RepositoriesClientPage({ initialUser }: RepositoriesClientPageProps) {
  ...
  useEffect(() => {
    const loadInstallationUrl = async () => {
      try {
            ...
            <PageSection surface className="p-6 md:p-8">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                {[
                  ...
                  '在 GitHub 中选择要授权的仓库，或直接授予全部仓库权限。',
